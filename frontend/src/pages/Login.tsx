  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-[11px] font-semibold tracking-[0.25em] uppercase text-ink-2">
            Agent Swarms
          </span>
        </motion.div>
          ...
          >
            ...
            <div className="mt-8 h-6 overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.p
                  key={taglineIdx}
                  className="text-[13px] font-medium tracking-[0.18em] uppercase text-ink-2"
        ...
        >
          {[
            ...
            <div key={label} className="flex items-center gap-2">
              ...
              <span className="text-[11px] tracking-widest uppercase text-ink-2">{label}</span>
            </div>
          ))}
        </motion.div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          >
            ...
            {loading ? (
              <svg className="animate-spin h-5 w-5 text-ink-2" fill="none" viewBox="0 0 24 24">
